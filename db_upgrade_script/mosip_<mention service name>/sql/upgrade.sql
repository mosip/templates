## To create an upgrade script from an older version to the latest version,
   you must create a sql script as described below.

## Reference for creating an upgrade script from an older version to the latest version:
...
## The complete block above explains how to create an upgrade script from a specific database.