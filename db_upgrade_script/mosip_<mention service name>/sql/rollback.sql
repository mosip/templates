## To create an rollback script ,you must create a sql script as described below.

## Reference for creating an rollback script :
...
## The complete block above explains how to create an rollback script from a specific database.